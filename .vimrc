...
set tags+=/SONIX_SDK/snx_sdk/tags
...
let OmniCpp_MayCompleteDot=1        "enable .     
let OmniCpp_MayCompleteArrow=1      "enable ->
let OmniCpp_MayCompleteScope=1      "enable ::
let OmniCpp_NamespaceSearch=1       "enable namespace
...
set statusline=%F%m%r\ %{strftime(\"%d-%m-%y\ %H:%M\")}\ [FORMAT=%{&ff}]\ [TYPE=%Y]\ [ASCII=\%b]\ [HEX=\%B]\ [POS:%l,%v]\ [LEN:%L]\ [%p%%]
        "设置在状态行显示的信息如下：
            "   %F              当前文件名
            "   %m              当前文件修改状态
            "   %r              当前文件是否只读
...
\<CR>*<CR>*   Author      :    l0op <l0op2018@gmail.com>
...
\<CR>*<CR>*   Return      :    
\<CR>*<CR>*   Description :
\<CR>*<CR>*   Author      :    <C-R>=GetDateTime()<ESC>   by   l0op <l0op2018@gmail.com>
\<CR>*<CR>
\*******************************************************************************
\<CR>*/<CR><CR>
...
\/* l0op Start  <C-R>=GetDateTime()<ESC> */<ESC>o
\/* l0op End <C-R>=GetDateTime()<ESC> */<ESC>O
...
\#if 0    //l0op Comment Start <C-R>=GetDateTime()<ESC><ESC>o
\#endif   //l0op Comment End   <C-R>=GetDateTime()<ESC><ESC>O<CR><ESC>p

nnoremap <silent> <F5> O
\#if 0    //l0op Comment Start <C-R>=GetDateTime()<ESC><ESC>o
\#endif   //l0op Comment End   <C-R>=GetDateTime()<ESC><ESC>O
...
vnoremap "y  :w! /tmp/l0op.vim<CR><CR>
vnoremap "p  :r /tmp/l0op.vim<CR><CR>
nnoremap "p  :r /tmp/l0op.vim<CR><CR>
